...
namespace DNA_Test
{
    public class BoxPlot
    {
        ...
        public BoxPlot(double minimum, double lower_quartile, double median, double upper_quartile, double maximum, double? mean = null)
        {
            this.Min = minimum;
        ...
        public DataPoint GetMean(double xValue)
        {
            if (Mean is double)
                return new DataPoint(xValue, (double)Mean);
            else
                throw new Exception("Mean was not specified");
        }
    }
}
